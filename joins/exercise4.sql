...
SELECT rec.firstname as recfname
, rec.surname as recfname, mem.firstname as memfname, mem.surname as memsname
  FROM cd.members as mem
  RIGHT  JOIN cd.members as rec ON mem.memid = rec.recommendedby
